      ...
      <div class="container-fluid">
        <!-- Small boxes (Stat box) -->
          ...
          <div class="col-md-10">
            ...
            {!! Form::open(['route' => ['backend.attribute.destroy',$data['record']->id],'method' => 'DELETE','style'=>'display:inline-block;float:right;margin-left:5px']) !!}
              {!! Form::submit('Trash',['class'=>'btn btn-danger']) !!}
            {!! Form::close() !!}
            <a href="{{route('backend.attribute.edit',$data['record']->id)}}" class="btn btn-warning float-right"><i class="fas fa-edit"></i>Edit </a>
